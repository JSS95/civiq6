...
.. code:: python
    ...
    from civiq6.qt_compat import QtCore

Or you can use :obj:`qt_api` which is an instance of :class:`QtAPI`.

.. code:: python

    from civiq6.qt_compat import qt_api
...
class QtAPI:
    ...
    .. code:: python
        ...
        from civiq6.qt_compat import QtAPI
    ...
    2. If ``CIVIQ_QT_API`` environment variable is set, use it.
    ...
    def __init__(self, api=os.environ.get("CIVIQ_QT_API")):
        self._import_errors = {}
